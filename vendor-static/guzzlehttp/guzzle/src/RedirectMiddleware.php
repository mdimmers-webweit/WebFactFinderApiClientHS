...
use GuzzleHttp6\Exception\BadResponseException;
use GuzzleHttp6\Exception\TooManyRedirectsException;
 ...
 * {@see \GuzzleHttp6\Middleware::redirect()}.
 */
class RedirectMiddleware
{
    ...
    public function checkRedirect(
        ...
        if (\mb_substr($response->getStatusCode(), 0, 1) !== '3'
