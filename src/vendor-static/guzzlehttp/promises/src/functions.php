 ...
 * @return array
 *
 * @see GuzzleHttp6\Promise\inspect for the inspection state array format.
 */
 ...
 *
 * This prommise is rejected with a {@see GuzzleHttp6\Promise\AggregateException}
