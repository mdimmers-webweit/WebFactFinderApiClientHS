...
use Web\FactFinderApi\Client\V4\Model\CartOrCheckoutEvent;
use Web\FactFinderApi\Client\V4\Model\ClickEvent;
use Web\FactFinderApi\Client\V4\Model\FeedbackEvent;
use Web\FactFinderApi\Client\V4\Model\LoginEvent;
use Web\FactFinderApi\Client\V4\Model\RecommendationClickEvent;
use Web\FactFinderApi\Client\V4\Model\SearchLogEvent;
