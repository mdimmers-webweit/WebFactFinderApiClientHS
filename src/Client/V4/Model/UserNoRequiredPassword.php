 ...
 */
class UserNoRequiredPassword extends BaseModel implements ModelV4Interface
{
    ...
    /**
     * @param string $password The password of the user in plaintext or null to use the old password. Passwords for users with origin=REMOTE cannot be changed. Attempt to do so will result in an error.
     *
     * @return $this
     */
    ...
    /**
     * @param string[] $roles The roles that will be assigned to the user. Roles for users with origin=REMOTE cannot be changed. Attempt to do so will result in an error.
     *
     * @return $this
     */
    ...
    /**
     * @param string[] $channels The channels that will be assigned to the user. Channels for users with origin=REMOTE cannot be changed. Attempt to do so will result in an error.
     *
     * @return $this
     */
    ...
    /**
     * @param string[] $groups The groups that will be assigned to the user. Groups for users with origin=REMOTE cannot be changed. Attempt to do so will result in an error.
     *
     * @return $this
     */
