...
class SearchApi extends ApiClient implements SearchApiInterface
{
     ...
     *
     * @param \Web\FactFinderApi\Client\V3\Model\SearchParams $params params (required)
     *
     * @throws \Web\FactFinderApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     *
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \Web\FactFinderApi\Client\V3\Model\ResultSuggestion[], HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param \Web\FactFinderApi\Client\V3\Model\NavigationRequest $navigation_request navigationRequest (required)
     *
     * @throws \Web\FactFinderApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     *
     ...
     * Search with POST
     *
     * @param \Web\FactFinderApi\Client\V3\Model\SearchRequest $search_request searchRequest (required)
     *
     * @throws \Web\FactFinderApi\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     *
    ...
    {
        $resourcePath = '/rest/v3/suggest/{channel}';
        $queryParams = [];
    ...
    {
        $resourcePath = '/rest/v3/navigation';
        $queryParams = [];
